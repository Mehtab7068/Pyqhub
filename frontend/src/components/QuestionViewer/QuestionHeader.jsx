        ...
        >
            ...
            >
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 text-sm text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors hidden sm:flex"
                ...
                <button
                    onClick={() => setShowReportModal(true)}
                    className="p-2 text-slate-400 hover:text-rose-400 hover:bg-rose-500/10 rounded-lg transition-colors sm:hidden"
                    title="Report Question"
                    aria-label="Report Question"
                >
